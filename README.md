...
The full API of this library can be found in the [api/OpenAI.netstandard2.0.cs](./api/OpenAI.netstandard2.0.cs) file, and there are many [code examples](./examples) to help. For instance, the following snippet illustrates the basic use of the chat completions API:
