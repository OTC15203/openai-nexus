...
| Folder | Description |
|--------|-------------|
| [`api/`](api/) | Public API listings (`OpenAI.net*.cs`) generated by `Export-Api.ps1`. Used to track public API changes. |
| [`codegen/`](codegen/) | TypeSpec emitter and C# generator plugins that transform TypeSpec definitions into C# code. |
| [`docs/`](docs/) | Guides and documentation. |
| [`examples/`](examples/) | Usage examples organized by feature area (Chat, Audio, Images, Assistants, etc.). |
| [`scripts/`](scripts/) | PowerShell scripts for development workflows (code generation, API export, testing). |
| [`specification/`](specification/) | TypeSpec definitions from which the client library is generated — `base/` contains the base API definitions and `client/` contains client-specific customizations. |
| [`src/`](src/) | Library source code — `Generated/` contains generated code and `Custom/` contains hand-written customizations. |
| [`tests/`](tests/) | NUnit tests with `SessionRecords/` for recorded playback mode. |
