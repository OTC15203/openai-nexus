<p align="center"><img src="../eng/OpenAI.png" alt="OpenAI logo" width="128"></p>
...
- **Solution**: The property directive format should be `#:property Key=Value` (e.g., `#:property PublishAot=false`).
